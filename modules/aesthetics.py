...
def render_progress(
    ...
    with c1:
        st.markdown(f"**Score:** {frac1}/{max1} ({pct1:.1f}%) \n\n**By Section**: [A1] {latest_p1["A1_raw"]}/{latest_p1["A1_max"]}; \t[A2] {latest_p1["A2_raw"]}/{latest_p1["A2_max"]}; \t[B] {latest_p1["B_raw"]}/{latest_p1["B_max"]}")
    with c2:
        st.markdown("**Comment:**") 
    ...
    with c3:
        st.markdown(f"**Score:** {frac2}/{max2} ({pct2:.1f}%) \n\n**By Section**: [A] {latest_p2["A_raw"]}/{latest_p2["A_max"]}; \t[B] {latest_p2["B_raw"]}/{latest_p2["B_max"]}")
    with c4:
        st.markdown("**Comment:**") 
